---
title: "Operationalisation categorization"
author: "Gjalt-Jorn Peters, Marwin Snippe & Gerjo Kok"
...
- **acceptibility**: On reflection, we conclude that these items are more lilely operationalisation of attitude than self-identity, because none of the three included items contains a reference to the self. *Exclude*
- **amSomeoneWho**: Retained as self-identity operationalisation. *Retain*
...
- **beingUnique**: This does not satisfy our criterion that the item must include the target behavior. *Exclude*
...
- **howIWantToLive**: These items measure how people want to behavior: how they want to live. They do not measure how people want to be, or who they want to be: therefore, these items are at best quite distal operationalisations of self-identity. Therefore, we will exclude them. *Exclude*
...
- **responsibility**: Having a responsibility is not the same as self-identity. *Exclude*
...
excluded_revision1 <- c('acceptibility', 'appropriateForMe',
                        'beingUnique', 'believeIn', 'characteristics',
...
## Discussion of first revision of operationalisation categories
...
## Discussion of second revision of operationalisation categories
...
* considerMyself: this category is conceptually homogeneous, but linguistically more heterogeneous. These operationalisations all express perceptions of oneself, using "I see myself as", "I think of myself as", or "I consider myself". A prototypical item is **"I [see|think of|consider] myself as [IDENTITY]"**.
...
- **"I [see|think of|consider] myself as someone who is concerned about [TARGET]"**
- **"I [see|think of|consider] myself as [IDENTITY]"**
- **"I would feel at a loss if I were forced to give up [TARGET]"**
- **"[TARGET] is an important part of who I am"**
- **"I am the [kind|type|sort] of person who [TARGET]"**
- **"For me, [TARGET] means more than just the act itself"**
- **"[TARGET] is something I rarely even think about"**
