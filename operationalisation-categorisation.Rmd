...
queryHitsFiles <- c("master-screening-edited finished backup.bib");
...
Screening results - exclusions based on abstract:

```{r}
knitr::kable(userfriendlyscience::freq(tolower(queryHits[[1]]$records$review_abstract))$dat);
```

Screening results - exclusions based on full text:
